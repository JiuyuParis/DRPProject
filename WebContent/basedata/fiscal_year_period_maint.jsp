...
<%@page import="basedata.manager.FiscalYearPeriodManager"%>
<%@page import="basedata.domain.FiscalYearPeriod"%>
...
<%
	...
	PageModel<FiscalYearPeriod> pageModel = FiscalYearPeriodManager.getInstance().findAllFiscalYearPeriod(pageNo, pageSize);
 %>	
<html>
	<head>
	...
	<body class="body1">
		<form name="fiscalYearPeriodForm" id="fiscalYearPeriodForm">
			...
			<table width="95%" border="1" cellspacing="0" cellpadding="0"
				...
				<tr>
					<td class="rd8">
						<input type="radio" name="selectFlag" id="selectFlag" value="<%=fiscalYearPeriod.getFiscalId() %>">
					</td>
					<td class="rd8">
						<%=fiscalYearPeriod.getFiscalYear() %>
					</td>
					<td class="rd8">
						<%=fiscalYearPeriod.getFiscalPeriod() %>
					</td>
					<td class="rd8">
			...
			<table width="95%" height="30" border="0" align="center"
				...
				<tr>
					<td nowrap class="rd19" height="2">
						<div align="left">
						<div align="left">
							&nbsp;共&nbsp<font color="red"><%=pageModel.getTotalPages() %></font>&nbsp页&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<font>当前第</font>&nbsp
							<font color="red"><%=pageModel.getPageNo() %></font>&nbsp
							<font>页</font>
						</div>
					</td>
