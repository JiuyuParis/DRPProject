...
<% 
	...
	if (command != null && command.equals("modify")) {
		...
		fiscalYearPeriod.setFiscalId(id);
						...
						<td>
							<label>
								<input type="text" name="beginDate" id="beginDate"  size="10" maxlength="10" 
									value="<%=new SimpleDateFormat("yyyy-MM-dd").format(fiscalYearPeriod.getBeginDate()) %>" onClick=JSCalendar(this)>
							</label>
						</td>
					</tr>
					<tr>
