...
<form name="itemForm" >
  ...
  <table width="95%" height="30" border="0" align="center" cellpadding="0" cellspacing="0" class="rd1">
    <tr> 
      <td  nowrap class="rd19" height="2" width="36%"> <div align="left">&nbsp;共&nbsp;<font color="red"><%=pageModel.getTotalPages() %></font>&nbsp;页&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;当前第&nbsp;<font color="red"><%=pageModel.getPageNo() %></font>&nbsp;页</div>
